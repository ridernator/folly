...
public class PlaceExecutionReport {
    ...
    public String toString(final int indent) {
        ...
        for (final PlaceInstructionReport placeInstructionReport : getInstructionReports()) {
            builder.append(placeInstructionReport.toString(indent + Indent.INDENT_SIZE)).append('\n');
        }
